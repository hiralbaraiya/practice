...
class SignUp extends Component {
    ...
    onClick(obj) {
       if( this.validate()){
        ...
        this.setState({firstname:'',lastname:'',password:'',email:''})
    }
    validate() {
        let valid=true;
...
render() {
    return (<div>
        <h1>Signup</h1>
        <p><input type='text' placeholder='firstname' onChange={e => this.onChange(e, 'firstname')} value={this.state.firstname} /></p>
        <p><input type='text' placeholder='lastname' onChange={e => this.onChange(e, 'lastname')} value={this.state.lastname}/></p>
